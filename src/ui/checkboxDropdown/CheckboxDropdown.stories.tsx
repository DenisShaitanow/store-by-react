...
export const Controlled: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Контролируемый режим с внешним управлением состоянием. Начальные значения установлены через selectedValues.'
            }
        }
    }
};
...
export const WithSearch: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Режим с поиском для больших списков опций. Поиск работает по названию города.'
            }
        }
    }
};
...
export const LargeList: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Большой список опций с поиском и скроллом. Некоторые опции отключены.'
            }
        }
    }
};
...
export const StaticMode: Story = {
    render: args => {
        const [selectedCities, setSelectedCities] = useState<
            (string | number)[]
        >([0, 1]); // Москва, Санкт-Петербург
        const [selectedSkills, setSelectedSkills] = useState<
            (string | number)[]
        >([0]); // Управление командой
    ...
    parameters: {
        docs: {
            description: {
                story: 'Статичный режим для компонента фильтров - без BaseDropdown, с заголовками и кнопками показать все/свернуть.'
            }
        }
    }
};
...
export const TreeMode: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Древовидная структура с подкатегориями. Поддерживает indeterminate состояние для родительских категорий.'
            }
        }
    }
};
...
export const FilterMode: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Комбинированный режим - dropdown с ограниченным списком и кнопкой "показать все/свернуть".'
            }
        }
    }
};
